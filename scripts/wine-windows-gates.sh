...
EOF
  ...
  # Exactly that signature earns up to five retries on a clean tree — the
  ...
  # the final attempt, fails loud with the log tail. A short backoff between
  # attempts lowers linker contention so the racers stop colliding.
  local attempt
